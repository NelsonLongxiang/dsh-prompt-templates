...
export const zh = {
  ...
  'panel.addCancel': '取消',
  'panel.insert': '插入',
  'panel.interject': '插话打断',
  'panel.newCategory': '新增分类',
  'panel.categoryName': '分类名称',
  'panel.categoryNone': '不设分类',
  'panel.category': '分类',
  'panel.deleteCategory': '删除分类',
  'panel.delete': '删除',
  'panel.edit': '编辑',
...
export const en = {
  ...
  'panel.insert': 'Insert',
  'panel.interject': 'Interject (steer)',
  'panel.newCategory': 'New category',
  'panel.categoryName': 'Category name',
  'panel.categoryNone': 'No category',
